...
try {
  ...
  check(await page.locator('.feature-tabs a').allTextContents().then((values) => values.join('|')) === 'Heatmap|Day Flow|Battle Lines|History|Stream Map|Data Status', 'Primary feature tabs changed.')
