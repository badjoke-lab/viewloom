...
async function check(browser, provider, viewport) {
  ...
  const periodUrl = new URL(highlightState.periodHref ?? '')
  ...
  assert(highlightState.dayFlowHref === `/${provider}/day-flow/?date=2026-06-06`, `${provider} period-highlight Day Flow link is incorrect.`)
  assert(highlightState.battleHref === `/${provider}/battle-lines/?date=2026-06-06`, `${provider} period-highlight Battle Lines link is incorrect.`)
