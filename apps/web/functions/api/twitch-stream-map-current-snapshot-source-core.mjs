 ...
 *
 * This is deliberately not a Pages Function route and does not read D1. It
 * accepts only the retained snapshot field `twitchUserId` as stable identity.
 * Login/display metadata never becomes a stable ID, and raw stream metadata is
 * discarded before the Current response core.
 */
