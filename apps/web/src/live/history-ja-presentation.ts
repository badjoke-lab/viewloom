...
const EXACT_TEXT = new Map<string, string>([
  ...
  ['Peak day', 'ピーク日'],
  ['Top streamer', '上位配信者'],
  ['Top streamers that day', 'その日の上位配信者'],
  ['Biggest rise', '最大上昇'],
  ...
  ['Daily streamer breakdown unavailable.', '日次の配信者内訳を利用できません。'],
  ['No retained streamer rollup is available yet.', '保持された配信者ロールアップはまだありません。'],
  ['No observed days are available for this range.', 'この期間に利用できる観測日はありません。'],
...
const RAW_TEXT_ANCESTORS = [
  ...
  '[data-history-selected-day] .history-selected-metrics > div:nth-child(3) strong',
  '[data-history-selected-day] .history-selected-top li span',
  '[data-history-daily-archive] .day-card dl > div:nth-child(2) dd',
].join(',')
