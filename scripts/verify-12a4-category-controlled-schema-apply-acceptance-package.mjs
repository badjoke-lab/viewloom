...
assert.equal(contract.gateFixPr, 532)
assert.equal(contract.triggerPr, 533)
assert.equal(contract.triggerMergeSha, 'a83b412e479dccb36ad04541843e3dd9456e7dff')
...
for (const text of [
  "github.head_ref == 'accept-analytics-12a4-category-controlled-schema-apply-v2'",
  'event=push',
