...
assert.equal(evidence.scenarios.length, 152)
assert.equal(japaneseCandidateRoutes.length, 11)
...
console.log('- Japanese candidate routes: 11 x 4 viewports')
