...
assert.equal(evidence.scenarios.length, 160)
assert.equal(japaneseCandidateRoutes.length, 13)
...
console.log('- Japanese candidate routes: 13 x 4 viewports')
