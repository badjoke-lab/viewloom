...
assert.equal(evidence.scenarios.length, 144)
assert.equal(japaneseCandidateRoutes.length, 9)
...
console.log('- Japanese candidate routes: 9 x 4 viewports')
