...
assert.equal(evidence.scenarios.length, 184)
assert.equal(japaneseCandidateRoutes.length, 19)
...
console.log('- Japanese candidate routes: 19 x 4 viewports')
