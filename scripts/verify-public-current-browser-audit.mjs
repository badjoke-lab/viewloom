...
assert.equal(evidence.scenarios.length, 128)
assert.equal(japaneseCandidateRoutes.length, 5)
...
console.log('- Japanese candidate routes: 5 x 4 viewports')
