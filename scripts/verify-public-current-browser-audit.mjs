...
assert.equal(evidence.scenarios.length, 136)
assert.equal(japaneseCandidateRoutes.length, 7)
...
console.log('- Japanese candidate routes: 7 x 4 viewports')
