...
import {
  ...
  parseLastJson,
  projectStorage,
} from './run-12a4-kick-permanent-category-observer.mjs'

const MB = 1024 * 1024
const normal = fs.readFileSync('workers/collector-kick/wrangler.toml', 'utf8')
const permanent = fs.readFileSync('workers/collector-kick/wrangler.category-permanent.toml', 'utf8')
...
assert.equal(toml(normal, 'name'), 'viewloom-collector-kick')
