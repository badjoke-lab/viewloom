...
assert.ok(state.generation.blockers.includes('account_aggregate_storage_unmeasured'))
assert.ok(state.generation.blockers.includes('remote_schema_apply_unverified'))
...
console.log('- repository migration acceptance state is coherent')
