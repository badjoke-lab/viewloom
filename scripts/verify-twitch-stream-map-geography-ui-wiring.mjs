...
if (/COUNTRY_CENTROIDS|setLngLat|new\s+.*Marker/i.test(cityGuard)) throw new Error('City aggregate selection must not introduce City/creator map points')
...
console.log(JSON.stringify({
  ...
  cityPointLayerIntroduced: false,
}, null, 2))
