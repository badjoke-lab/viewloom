...
check(contract.triggerPr === 525, 'retry trigger PR')
check(contract.triggerMergeSha === 'e78e21ef55fc3aadf22477308a2bcc25e44c71b0', 'retry trigger merge SHA')
...
check(workflow.includes(contract.triggerMergeSha), 'retry trigger SHA pin')
