...
if (!existsSync(join(root, 'docs/audits/history-ui-h0-owner-map.json'))) {
  issues.push('missing file: docs/audits/history-ui-h0-owner-map.json')
} else {
...
console.log('- the completed P9H0 baseline remains intact')
console.log('- later roadmap handoffs are intentionally not part of this historical gate')
