...
assert.ok(tailAudit.includes("spawn('pnpm', ['dlx', 'wrangler@4', 'tail'"))
assert.ok(tailAudit.includes('const TAIL_DURATION_MS = 8 * 60 * 1000'))
...
assert.ok(tailAudit.includes("child.kill('SIGINT')"))
