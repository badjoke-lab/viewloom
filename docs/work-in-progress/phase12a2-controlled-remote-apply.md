...
Branch: `work-analytics-12a2-controlled-schema-apply`

## Purpose

Apply the accepted compact intraday schema through existing provider-specific collector D1 bindings without adding a public DDL route or a new cron.
...
maximum bootstrap attempts/provider/day: 2
```
...
then, in finally, checks remote schema object count
