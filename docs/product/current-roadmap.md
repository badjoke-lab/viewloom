...
The following exact values describe the roadmap before PR #436 merged. They are retained for permanent P9H2 acceptance gates and are not the current execution state.
